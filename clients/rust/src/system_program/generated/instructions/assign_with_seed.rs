...
impl AssignWithSeedBuilder {
    ...
    #[inline(always)]
    pub fn base_pubkey(&mut self, base_pubkey: Pubkey) -> &mut Self {
        self.base_pubkey = Some(base_pubkey);
        self
    }
    #[inline(always)]
    ...
    pub fn instruction(&self) -> solana_program::instruction::Instruction {
        ...
        let args = AssignWithSeedInstructionArgs {
            base_pubkey: self.base_pubkey.clone().expect("base_pubkey is not set"),
...
impl<'a, 'b> AssignWithSeedCpiBuilder<'a, 'b> {
    ...
    #[inline(always)]
    pub fn base_pubkey(&mut self, base_pubkey: Pubkey) -> &mut Self {
        self.instruction.base_pubkey = Some(base_pubkey);
        self
    }
    #[inline(always)]
    pub fn seed(&mut self, seed: String) -> &mut Self {
